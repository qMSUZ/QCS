...
void qcs_calculate_norm1_of_column_vector(tf_qcs_matrix *a_mat, tf_qcs_real_number *norm_val_out);
void qcs_calculate_norm2_of_column_vector(tf_qcs_matrix *a_mat, tf_qcs_real_number *norm_val_out);
...
void qcs_print_matrix_in_matlab_format_with_prefix(tf_qcs_matrix *a_in, char *prefix_str);
